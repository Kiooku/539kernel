...
gdt:
    ...
    userspace_date_descriptor   :   dw 0xffff, 0x0000, 0xf200, 0x00cf
    tss_descriptor              :   dw tss + 3, tss, 0x8900, 0x0000

; Content of the special register GDTR that should be loaded by the starter to make the processor uses 539kernel's GDT
gdtr:
